...
export default class Creditos {
  ...
  public static updateCreditoById = (req: Request, res: Response) =>{
    try {
      const query = `
                UPDATE creditos
                SET monto_cred      = '${req.body.monto}', 
                    plazo_cred      = ${req.body.plazo}, 
                    valorcuota_cred = ${req.body.valorcuota}, 
                    estado_cred     = ${req.body.estado}, 
                    comentario_cred = '${req.body.comentario}'
