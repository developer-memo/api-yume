 ...
 */
router.post('/api/insertProject', middleware.validarJWT, (req: Request, res: Response) =>{
 ...
 */
router.post('/api/uploadImage', middleware.validarJWT, (req: Request, res: Response) =>{
 ...
 */
 router.get('/api/ingreso/:id', middleware.validarJWT, ( req: Request, res: Response ) =>{
 ...
 */
 router.get('/api/egreso/:id', middleware.validarJWT, ( req: Request, res: Response ) =>{
 ...
 */
router.get('/api/getarchivo/:extension/:archivo', ( req: Request, res: Response ) =>{
 ...
 */
router.put('/api/updateUser', middleware.validarJWT, (req: Request, res: Response ) =>{
 ...
 */
router.put('/api/updateProject', middleware.validarJWT, (req: Request, res: Response ) =>{
 ...
 */
router.delete('/api/deleteImage/:nomArchivo', middleware.validarJWT, (req: Request, res: Response ) =>{
 ...
 */
router.delete('/api/deleteProject/:id', middleware.validarJWT, (req: Request, res: Response ) =>{
